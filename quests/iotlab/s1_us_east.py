...
def main():
    ...
    for i in range(1, args.num_messages + 1):
        ...
        simulated_temp = random.uniform(68, 72)
        simulated_humidity = random.uniform(24, 29)
        simulated_pressure = random.uniform(12, 14.7)
        simulated_dewpoint = random.uniform(29, 34)
		
        ####### Payload Publish ###########################################
        payload = {"timestamp": int(time.time()), "device": args.device_id, "temperature": round(simulated_temp,3), "humidity": round(simulated_humidity,3), "pressure": round(simulated_pressure,3), "dewpoint": round(simulated_dewpoint,3), "metrocode": 1023191}
