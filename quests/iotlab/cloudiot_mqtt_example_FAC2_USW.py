...
def main():
    ...
    for i in range(1, args.num_messages + 1):
        ...
        ####### Payload Publish ###########################################
        payload = {"timestamp": int(time.time()), "device": args.device_id, "temperature": round(simulated_temp,2), "humidity": simulated_humidity, "pressure": simulated_pressure, "dewpoint": simulated_dewpoint, "Longitude": 37.4219999, "Latitude": -122.0840575}
