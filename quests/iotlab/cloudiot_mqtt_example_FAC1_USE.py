...
def main():
    ...
    for i in range(1, args.num_messages + 1):
        ...
        ####### Payload Publish ###########################################
        payload = OrderedDict[("timestamp": int(time.time()), "device": args.device_id, "temperature": simulated_temp, "humidity": simulated_humidity, "pressure": simulated_pressure, "dewpoint": simulated_dewpoint, "longitude": longitude, "latitude": latitude)]
